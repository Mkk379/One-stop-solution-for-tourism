...
public final class ActivityViewListBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvzlIst;

  @NonNull
  public final TextView textView2;

  private ActivityViewListBinding(@NonNull ScrollView rootView, @NonNull ScrollView main,
      @NonNull ProgressBar progressBar4, @NonNull RecyclerView rvzlIst,
      @NonNull TextView textView2) {
    this.rootView = rootView;
    this.main = main;
    this.progressBar4 = progressBar4;
    this.rvzlIst = rvzlIst;
  ...
  public static ActivityViewListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rvzlIst;
      RecyclerView rvzlIst = ViewBindings.findChildViewById(rootView, id);
      if (rvzlIst == null) {
        break missingId;
      }
      ...
      return new ActivityViewListBinding((ScrollView) rootView, main, progressBar4, rvzlIst,
          textView2);
    }
